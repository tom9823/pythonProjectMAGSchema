...
class ImageLabeler:
    def __init__(self, master):
        ...
        self.load_button = Button(self.label_frame, text="Carica Cartella", command=self.load_folder)
        self.load_button.pack(side="left")

        self.save_button = Button(self.label_frame, text="Salva Etichette", command=self.save_labels)
        ...
        self.image_listbox = Listbox(master, height=20)
    ...
    def load_folder(self):
        ...
        if folder_path:
            self.images = [f for f in os.listdir(folder_path) if f.lower().endswith(('png', 'jpg', 'jpeg', 'gif', 'bmp', 'tif', 'tiff'))]
